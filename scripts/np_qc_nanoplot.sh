...
# --no-home removed since singularity 2.5.1 doesn't have that option
singularity exec -B ${INDIR}:/data /apps/standalone/singularity/nanoplot/nanoplot.1.29.0.staphb.simg \
